...
Mesh Model::ProcessMesh(aiMesh *mesh, const aiScene *scene) { //TODO : add normals
        ...
        {
            Vertex vertex;
            vec3_f vector; // we declare a placeholder vector since assimp uses its own vector class that doesn't directly convert to glm's vec3 class so we transfer the data to this placeholder glm::vec3 first.
            // positions
            ...
            if(mesh->mTextureCoords[0]) // does the mesh contain texture coordinates?
            {
                ...
                vertex.texcoords = vec2_f(0.0f, 0.0f);
...
std::vector<Texture> Model::LoadTextures(aiMaterial *mat, aiTextureType type, std::string tn) {
    std::vector<Texture> textures;
